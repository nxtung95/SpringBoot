package course.configuration.security;
...
import course.jwt.JwtAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(AuthenticationManagerBuilder auth)
            throws Exception {
        auth.userDetailsService(loginUserService) // Cung cáp userservice cho spring security
