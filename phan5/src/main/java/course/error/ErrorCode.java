...
public class ErrorCode {
    public static final String USER_E001 = "USER_E001";
    public static final String USER_E002 = "USER_E002";
    public static final String USER_E003 = "USER_E003";
    public static final String USER_E004 = "USER_E004";
